...
public class Klasemen extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener
{
	...
	swipeRefreshLayout.setOnRefreshListener(Klasemen.this);  
	...
	if (netInfo != null && netInfo.isConnectedOrConnecting()) {        
	    mWebView.loadUrl("https://liga-indonesia.id/klasemen/liga-2");      }
	else {            
	...
	//Tampilkan Toolbar
	tb = (Toolbar) findViewById(R.id.toolbar_klasemen);
