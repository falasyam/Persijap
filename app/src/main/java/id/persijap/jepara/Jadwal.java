...
{ 
	...
	swipeRefreshLayout.setOnRefreshListener(Jadwal.this);  
	...
	if (netInfo != null && netInfo.isConnectedOrConnecting()) {        
	    mWebView.loadUrl("https://persijapday.wordpress.com/2017/07/11/jadwal-persijap-jepara-liga-2-2017");      }
	else {            
	...
	//Tampilkan Toolbar
	tb = (Toolbar) findViewById(R.id.toolbar_berita);
