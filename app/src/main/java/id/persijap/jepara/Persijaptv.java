...
public class Persijaptv extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener
{
	...
	setContentView(R.layout.persijaptv);
	Toolbar();

	mWebView = (WebView) findViewById(R.id.activity_main_webview);   
	swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swiperefresh);         
	swipeRefreshLayout.setOnRefreshListener(Persijaptv.this);  
	...
	if (netInfo != null && netInfo.isConnectedOrConnecting()) {        
	    mWebView.loadUrl("https://m.youtube.com/channel/UCXJfemTC3RF8P5yVCB03AlQ");      }
	else {            
	...
	//Tampilkan Toolbar
	tb = (Toolbar) findViewById(R.id.toolbar_tv);
